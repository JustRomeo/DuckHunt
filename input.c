...
int killing(sfVector2i mouse, ducker *duck, ducker *duck2, ducker *duck3, sfMusic *music, int height, int width, int *hit) {
...
int input_event(sfMouseButtonEvent event, sfRenderWindow *window, sfVector2i mouse, ducker *duck, ducker *duck2, ducker *duck3, sfMusic *music, int height, int width, int *hit) {
    ...
    switch (event.type) {
        case sfEvtMouseButtonPressed : score = killing(mouse, duck, duck2, duck3, music, height, width, hit); break;
